...
- **Thesis Project: Machine Learning Applications in Dairy Buffalo Farming**
<br>
...
<br>
Developed a time-series forecasting pipeline to predict hourly traffic volume for multiple toll plazas.<br>
Benchmarked classical statistical methods (Holt-Winters) against Gradient Boosting algorithms (LightGBM).
<br>
**2025**
<br>
<hr>

- **CHRONOS FORECASTING FRAMEWORK**
<br>
...
- **OIL SPILL DETECTION WITH HYPERSPECTRAL IMAGING**
<br>
